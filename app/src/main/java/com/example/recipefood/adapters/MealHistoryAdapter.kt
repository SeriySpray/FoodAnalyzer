...
import com.example.recipefood.databinding.ItemMealHistoryBinding
...
class MealHistoryAdapter(
    ...
    override fun onBindViewHolder(holder: MealViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            tvProteins.text = "Б: ${String.format("%.1f", meal.totalProteins)}г"
            tvFats.text = "Ж: ${String.format("%.1f", meal.totalFats)}г"
            tvCarbs.text = "В: ${String.format("%.1f", meal.totalCarbs)}г"
